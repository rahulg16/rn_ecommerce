...
const ProductDetailsScreen = (props: ProductDetailsScreen) => {
  ...
  // let rating = Math.floor(productDetails?.rating);
  console.log('productDetails?.rating', productDetails?.rating);
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      <View style={styles.headerContainer}>
        <Header isBack isCart count={1} navigation={props.navigation} />
      ...
      <View
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Text
            style={{color: '#2A4BA0', fontSize: Scale(16), fontWeight: 'bold'}}>
        ...
        <View
          ...
          <Button title="Add To Cart" isOutline style={{width: '46%'}} />
          <Button title="Buy Now" style={{width: '46%'}} />
        </View>

        <View>
          <Text style={{color: '#1E222B', fontSize: Scale(16)}}>Details</Text>
          <Text
            style={{color: '#8891A5', fontSize: Scale(16), textAlign: 'left'}}>
